...
class TvGenrePagingDataSource @Inject constructor(private val apiService: ApiService, private val genreId: String) : PagingSource<Int, TvSeriesItem>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, TvSeriesItem> {
        return try {
            ...
            val movieList = apiService.tvByGenre(nextPage, genreId)
            LoadResult.Page(
